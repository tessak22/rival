 ...
 * Why low effort: homepages are usually static/server-rendered marketing content.
 *
 * Fallback: /automate when extract/json is empty.
 */
...
export const HOMEPAGE_SCHEMA = {
  ...
  properties: {
    ...
    key_differentiators: {
      type: "array",
      items: { type: "string" },
      description: "Explicit uniqueness or superiority claims."
    },
    ...
    social_proof_summary: {
      type: "string",
      description: "Summary of logos, counts, ratings, or recognition."
    },
    nav_primary_items: {
      type: "array",
      items: { type: "string" },
